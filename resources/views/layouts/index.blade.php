...
<head>
    <meta charset="utf-8">
    <title>Deep & Blog - Home 2 Columns with Sidebar</title>
	...
	{{-- {{asset('')}} Đường dẫn phải chèn thêm--}}
<body>
                ...
                <ul class="tada-menu">
                     <li><a href="#" class="active">HOME <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                            ...
                            <li><a href="home-2-columns-with-sidebar.html" class="active">Home 2 Columns + Sidebar</a></li>
        ...
        <div class="tada-search">
			<form action="search" method="POST">
            	<div class="form-group-search">
                    {{csrf_field()}}
              		<input type="search" name="search" class="search-field" placeholder="Search and hit enter...">
